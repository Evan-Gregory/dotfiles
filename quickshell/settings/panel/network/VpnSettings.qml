...
ColumnLayout {
    ...
    SectionContainer {
        ...
        ListView {
            ...
            model: ScriptModel {
                values: Config.vpn.provider.map((provider, index) => {
                ...
                StyledRect {
                    ...
                    RowLayout {
                        ...
                        IconButton {
                            ...
                            visible: !modelData.isActive || Config.vpn.provider.length > 1
                            onClicked: {
                                if (modelData.isActive && index < Config.vpn.provider.length - 1) {
                                    // Move down
                                    const providers = [...Config.vpn.provider];
