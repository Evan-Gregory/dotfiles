...
ClippingRectangle {
    ...
    // Content-area background. The nav rail uses the slightly-elevated
    // m3surfaceContainer, so the panes sit on the base m3surface for the
    // standard Material two-tone (was transparent in the source, which
    // assumed a window-level background painted behind it).
