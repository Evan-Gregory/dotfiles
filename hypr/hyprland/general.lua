hl.config({
	general = {
		...
		col = {
			-- active_border = "0xcba6f7ff 0x89b4faff 0x94e2d5ff 45deg",
	...
	-- NOTE: the swipe gesture itself is now defined with hl.gesture() below.
	-- This table only holds the workspace-swipe *tuning* knobs (all optional):
	gestures = {
		-- workspace_swipe_distance = 300,
		workspace_swipe_invert = true, -- flip direction (natural-scroll feel)
...
-- Touchpad gestures (replaces the old `gestures { workspace_swipe }` block).
