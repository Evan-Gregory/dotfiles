...
if $nu.is-interactive {
	...
	# ~/.config/fish/tty.sh 
        cat ~/.local/state/caelestia/sequences.txt err> /dev/null
} else {}
...
def --env 'login aws' [] {
    ...
    $env.BROWSER = "flatpak run com.vivaldi.Vivaldi %s"
    aws sso login
}
...
$env.PATH = ($env.PATH | split row (char esep)) | prepend  "/home/evang/.local/bin" 
source "~/.cargo/env.nu"
